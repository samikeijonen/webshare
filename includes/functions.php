...
function webshare() { ?>
	...
	<div id="webshare-wrapper">
		<ul id="webshare" class="webshare webshare-links">
			...
			<li class="webshare-twitter"><a class="webshare-twitter" href="https://twitter.com/intent/tweet?url=<?php echo the_permalink(); ?>&text=<?php urlencode( the_title() ); echo $via_twitter; ?>" target="_blank" title="<?php _e( 'Twitter', 'webshare' ); ?>"><span class="screen-reader-text webshare-link webshare-link-twitter"><?php _e( 'Twitter', 'webshare' ); ?></span></a></li>
