...
grunt.initConfig({
  pkg: grunt.file.readJSON('package.json'),
    ...
    makepot: {
      target: {
        options: {
          ...
          potFilename: 'webshare.pot',  // Name of the POT file.
	...
	cssmin : {
		css: {
			src: 'css/webshare-styles.css',
			dest: 'css/webshare-styles.min.css'
		},
		genericons: {
			src: 'css/genericons/genericons/genericons.css',
			dest: 'css/genericons/genericons/genericons.min.css'
		}
	},
